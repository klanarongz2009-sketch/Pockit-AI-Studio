...
interface NonAiCreativePageProps {
    onClose: () => void;
...
export const ImageToSoundPage: React.FC<NonAiCreativePageProps> = ({ onClose, playSound }) => {
    const { t } = useLanguage();
