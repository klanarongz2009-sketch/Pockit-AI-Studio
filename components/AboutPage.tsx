...
export const AboutPage: React.FC<AboutPageProps> = ({ onClose, playSound, isOnline }) => {
    ...
    const allFiles = [
        ...
        'components/AboutPage.tsx', 'components/AdPlayer.tsx', 'components/AiBugSquasherPage.tsx', 'components/AiChatPage.tsx', 'components/AiDetectorPage.tsx', 'components/AiOraclePage.tsx',
        ...
        'components/TranslatorPage.tsx', 'components/UpdateInfoPage.tsx', 'components/VideoEditorPage.tsx', 'components/VoiceChangerPage.tsx', 'components/WordMatchPage.tsx', 'components/icon.svg', 'components/icons/AiDetectorIcon.tsx',
        'components/icons/AnalyzeIcon.tsx', 'components/icons/ArticleIcon.tsx', 'components/icons/AsteroidShooterIcon.tsx', 'components/icons/AudioTransformIcon.tsx', 'components/icons/AudioVisualizer.tsx', 'components/icons/BellIcon.tsx',
        'components/icons/BellOffIcon.tsx', 'components/icons/BookmarkIcon.tsx', 'components/icons/BrickBreakerIcon.tsx', 'components/icons/BugIcon.tsx', 'components/icons/CalculatorIcon.tsx', 'components/icons/CalculatorPage.tsx',
        'components/icons/ChatIcon.tsx', 'components/icons/CodeIcon.tsx', 'components/icons/CoinsIcon.tsx', 'components/icons/ColorPickerIcon.tsx', 'components/icons/CopyIcon.tsx', 'components/icons/CropIcon.tsx',
        'components/icons/DeviceDetailsPage.tsx', 'components/icons/DeviceIcon.tsx', 'components/icons/DownloadIcon.tsx', 'components/icons/EarnCreditsModal.tsx', 'components/icons/EmulatorIcon.tsx', 'components/icons/FaceLostIcon.tsx',
        'components/icons/FacePlayingIcon.tsx', 'components/icons/FaceWonIcon.tsx', 'components/icons/FeedbackIcon.tsx', 'components/icons/FileChatIcon.tsx', 'components/icons/FilmMusicIcon.tsx', 'components/icons/FlagCheekIcon.tsx',
        'components/icons/GalleryIcon.tsx', 'components/icons/GamepadIcon.tsx', 'components/icons/GuessThePromptIcon.tsx', 'components/icons/HeartFilledIcon.tsx', 'components/icons/HeartIcon.tsx', 'components/icons/ImageSoundIcon.tsx',
        'components/icons/InfoIcon.tsx', 'components/icons/InstallIcon.tsx', 'components/icons/JumpingIcon.tsx', 'components/icons/LinkIcon.tsx', 'components/icons/MagicButtonIcon.tsx', 'components/icons/MenuIcon.tsx',
        'components/icons/MicrophoneIcon.tsx', 'components/icons/MineCheekIcon.tsx', 'components/icons/MinesweeperIcon.tsx', 'components/icons/MoonIcon.tsx', 'components/icons/MusicAndSoundIcon.tsx', 'components/icons/MusicInspectIcon.tsx',
        'components/icons/MusicKeyboardIcon.tsx', 'components/icons/MusicNoteIcon.tsx', 'components/icons/OfflineAiIcon.tsx', 'components/icons/OracleIcon.tsx', 'components/icons/PaletteIcon.tsx', 'components/icons/PetIcon.tsx',
        'components/icons/PlatformerIcon.tsx', 'components/icons/PlayIcon.tsx', 'components/icons/PlusSquareIcon.tsx', 'components/icons/PublishIcon.tsx', 'components/icons/RecordIcon.tsx', 'components/icons/RegenerateIcon.tsx',
        'components/icons/ReverseIcon.tsx', 'components/icons/SearchIcon.tsx', 'components/icons/SearchMusicIcon.tsx', 'components/icons/SendIcon.tsx', 'components/icons/SequencerIcon.tsx', 'components/icons/SettingsIcon.tsx',
        'components/icons/ShareIcon.tsx', 'components/icons/SnakeIcon.tsx', 'components/icons/SoundWaveIcon.tsx', 'components/icons/SparklesIcon.tsx', 'components/icons/SpeakerOffIcon.tsx', 'components/icons/SpeakerOnIcon.tsx', 'components/icons/SpriteSheetIcon.tsx',
        'components/icons/StopIcon.tsx', 'components/icons/SubtitlesIcon.tsx', 'components/icons/SunIcon.tsx', 'components/icons/TextMusicIcon.tsx', 'components/icons/TextToSpeechIcon.tsx', 'components/icons/ThumbsDownIcon.tsx', 'components/icons/ThumbsUpIcon.tsx',
        'components/icons/TicTacToeIcon.tsx', 'components/icons/TranslateIcon.tsx', 'components/icons/TrashIcon.tsx', 'components/icons/UpdateIcon.tsx', 'components/icons/UploadIcon.tsx', 'components/icons/VideoEditorIcon.tsx', 'components/icons/VoiceChangerIcon.tsx', 'components/icons/WordMatchIcon.tsx', 'components/icons/XIcon.tsx'
    ];
    ...
    const handleDownloadSource = useCallback(async () => {
        ...
        try {
            const zip = new JSZip();
            const fetchPromises = allFiles.map(filePath =>
                fetch(`/${filePath}`)
                    .then(res => {
                        if (!res.ok) {
                           console.warn(`Skipping missing file for zip: ${filePath}`);
            ...
            const fileContents = await Promise.all(
                allFiles.map(filePath =>
                    fetch(`/${filePath}`)
                        .then(res => {
                            if (!res.ok) {
                                console.warn(`Skipping missing file for copy: ${filePath}`);
                                return null;
                            }
                            return res.text();
                        })
                        .then(content => {
                            if (content === null || content.trim() === '') return ''; // Skip empty files
    ...
    return (
        <PageWrapper>
            ...
            <main id="main-content" className="w-full max-w-2xl flex-grow overflow-y-auto font-sans px-2 pb-8 space-y-6">
                 <Modal
                    isOpen={!!fallbackContent}
                    onClose={() => setFallbackContent(null)}
                    title="Manual Copy Required"
                >
                    <div className="flex flex-col h-[calc(80vh)]">
                        <p className="font-sans text-sm mb-2">
                            Automatic copy failed due to browser security settings. Please copy the code below manually (it has been selected for you).
                        </p>
                        <textarea
                            readOnly
                            value={fallbackContent || ''}
                            className="w-full flex-grow p-2 bg-black text-brand-lime font-mono text-xs border border-brand-light/50"
                            aria-label="Full application code"
                ...
                <Section title={t('about.install.title')} id="install-guide">
                    ...
                    <p className="text-xs">{t('about.install.rom.description')}</p>
                     <div className="flex flex-col sm:flex-row gap-2 mt-2">
                        <button onClick={handleDownloadSource} disabled={isDownloading} className="flex-1 p-2 bg-brand-yellow text-black border-2 border-black font-press-start text-xs hover:bg-brand-lime disabled:bg-gray-500 disabled:cursor-wait">
                        ...
                        <button onClick={handleCopyAllFiles} disabled={isCopying} className="flex-1 p-2 bg-brand-cyan text-black border-2 border-black font-press-start text-xs hover:bg-brand-lime disabled:bg-gray-500 disabled:cursor-wait">
                             <InstructionStep icon={isCopying ? <LoadingSpinner text=""/> : <CopyIcon className="w-6 h-6" />}>
                                {isCopying ? 'Copying...' : (copySuccess ? 'Copied!' : 'Copy All Files')}
                            </InstructionStep>
                        </button>
                    </div>
                </Section>
