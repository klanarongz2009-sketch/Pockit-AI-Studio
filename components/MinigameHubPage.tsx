...
type ActiveGame =
    ...
    | 'jumpingGame' | 'deviceDetails' | 'aiDetector' | 'talkingCat' | 'appPublisher';
    ...
    const categories = useMemo(() => [
        { 
            ...
            items: [
                ...
                { icon: <PetIcon className="w-16 h-16" />, title: "AI Pet Workshop", description: "Create and customize your own digital pet using parts generated by AI.", comingSoon: true }
            ]
        },
        {
            title: "AI Utilities",
