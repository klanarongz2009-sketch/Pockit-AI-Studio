...
const voiceSections: VoiceSection[] = [
  {
    title: 'เครื่องมือ AI',
    description: 'ใช้พลังของ AI และเครื่องมือขั้นสูงเพื่อปรับแต่งเสียงของคุณ',
    options: [
      { 
        label: 'โคลนเสียง AI', 
        effect: 'ai-voice-clone', 
        beta: true,
        description: 'ฟีเจอร์นี้อยู่ในช่วงทดลองและอาจทำงานได้ไม่สมบูรณ์บนเสียงบางประเภท โดยเฉพาะเสียงที่มีความซับซ้อนสูง'
      },
      { 
        label: 'เสียง AI', 
        effect: 'ai-voice-style',
        description: 'ปรับความเป็น AI ของเสียง จากเสียงปกติไปจนถึงเสียงสังเคราะห์เต็มรูปแบบ',
        controls: [{ type: 'slider', param: 'aiLevel', label: 'ความเป็น AI', min: 0, max: 10, step: 1, defaultValue: 5 }]
      },
      { 
        label: 'สไตล์ Suno AI', 
        effect: 'ai-suno-style',
        description: 'ปรับสไตล์เสียงของคุณให้เหมือนกับ AI ของ Suno ในเวอร์ชันต่างๆ จาก V2 (ซ้าย) ถึง V4.5+ (ขวา)',
        controls: [{ type: 'slider', param: 'sunoVersion', label: 'เวอร์ชัน AI', min: 2.0, max: 4.5, step: 0.1, defaultValue: 3.5 }]
      },
      { 
        label: 'ปรับความชัด', 
      ...
      { label: 'ปรับปรุงเสียง AI', effect: 'ai-voice-enhancer', description: 'ใช้ AI เพื่อปรับปรุงคุณภาพเสียงพูดให้คมชัด' },
      { label: 'เสียงผู้บรรยาย AI', effect: 'ai-narrator', description: 'สร้างเสียงผู้บรรยายที่นุ่มลึกและชัดเจน' },
      { label: 'ลบเสียงรบกวน', effect: 'ai-noise-removal', description: 'กำจัดเสียงรบกวนพื้นหลังออกจากเสียงของคุณ' },
      { 
        label: 'กรองเสียงฮัม', 
        effect: 'hum-remover',
        description: 'กำจัดเสียงฮัมความถี่ต่ำที่น่ารำคาญออกไป',
        controls: [{ type: 'slider', param: 'humFrequency', label: 'ความถี่', min: 40, max: 150, step: 1, defaultValue: 60 }]
      },
    ]
  },
  {
    title: 'เครื่องมือสำหรับเพลง',
    description: 'รีมิกซ์และแปลงโฉมไฟล์เพลงของคุณด้วยเอฟเฟกต์พิเศษ',
    options: [
        {
            label: 'รีมิกซ์เป็น Lofi',
            effect: 'ai-lofi-remix',
            description: 'เปลี่ยนเพลงของคุณให้เป็นแนว Lofi ฟังสบายๆ',
            controls: [
                { type: 'slider', param: 'lofiVintage', label: 'ความเก่า', min: 0, max: 10, step: 1, defaultValue: 5 }
            ]
        },
        {
            label: 'สร้างเสียงคาราโอเกะ',
            effect: 'ai-vocal-isolation',
            description: 'พยายามลบเสียงร้องออกจากเพลง (ได้ผลดีกับไฟล์สเตอริโอ)'
        },
        { 
            label: 'รีมิกซ์เป็น 8-บิต', 
            effect: '8-bit-classic', 
            description: 'แปลงเพลงของคุณให้เป็นสไตล์ Chiptune ย้อนยุค',
            controls: [
              { type: 'slider', param: 'bitCrushLevel', label: 'ความลึกบิต', min: 1, max: 16, step: 1, defaultValue: 6 },
              { type: 'slider', param: 'sampleRateCrushLevel', label: 'อัตราสุ่ม', min: 1, max: 40, step: 1, defaultValue: 15 }
            ]
        },
        {
            label: 'เพิ่มเสียงเบส',
            effect: 'bass-boost',
            description: 'เพิ่มความหนักแน่นให้กับย่านความถี่ต่ำของเพลง',
            controls: [
        ...
        {
            label: 'แยกเสียงกลอง',
            effect: 'drum-isolator',
            description: 'พยายามแยกและเน้นเสียงกลองในเพลง (ทดลอง)',
            controls: [{ type: 'slider', param: 'snareBoost', label: 'เน้นเสียงสแนร์', min: 0, max: 15, step: 1, defaultValue: 5 }]
        }
    ]
  },
  {
    title: 'สไตล์เรโทร',
    description: 'ย้อนยุคไปกับเอฟเฟกต์เสียงสุดคลาสสิก',
    options: [
      { 
        label: 'วิทยุเก่า', 
        effect: 'old-radio', 
        description: 'จำลองเสียงจากวิทยุ AM แบบโบราณ',
        controls: [{ type: 'slider', param: 'radioFrequency', label: 'ปรับคลื่น', min: 500, max: 4000, step: 50, defaultValue: 1500 }]
      },
      { label: 'โทรศัพท์', effect: 'telephone', description: 'ทำให้เสียงของคุณเหมือนกำลังคุยผ่านสายโทรศัพท์' },
      { label: '8-Bit V2', effect: '8-bit-v2', description: 'อีกหนึ่งรสชาติของเสียง 8-bit ที่มีความดิบและแตกต่าง' },
    ]
  },
  {
    title: 'เอฟเฟกต์สนุกๆ',
    ...
    options: [
       { 
        ...
        effect: 'pitch-shift', 
        description: 'ปรับเสียงให้สูงขึ้นหรือต่ำลง (ส่งผลต่อความเร็ว)',
      ...
      },
      {
       ...
       {
        label: 'เสียงก้องกังวาน',
        effect: 'reverb',
        description: 'เพิ่มมิติให้เสียงเหมือนอยู่ในห้องโถง, ถ้ำ',
        controls: [
...
export const VoiceChangerPage: React.FC<VoiceChangerPageProps> = ({ playSound, onClose }) => {
    ...
    }, [uploadedFile, isLoading, stopPlayback, playSound, selectedEffect.effect, effectParams]);
