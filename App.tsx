        ...
        <PageWrapper className="justify-between">
            ...
            <div className="absolute top-4 right-4 flex items-center gap-2 z-10">
                 <button
                    ...
                    className="h-10 flex items-center justify-center gap-2 px-3 bg-black/50 border-2 border-brand-light text-brand-light hover:bg-brand-yellow hover:text-black transition-colors"
                >
                ...
                <button
                    ...
                    className="w-10 h-10 flex items-center justify-center bg-black/50 border-2 border-brand-light text-brand-light hover:bg-brand-yellow hover:text-black transition-colors"
                >
